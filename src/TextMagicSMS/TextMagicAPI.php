 ...
 *
 */
use TextMagicSMS\Exception\AuthenticationException;
use TextMagicSMS\Exception\DisabledAccountException;
use TextMagicSMS\Exception\IPAddressException;
use TextMagicSMS\Exception\LowBalanceException;
use TextMagicSMS\Exception\RequestsLimitExceededException;
use TextMagicSMS\Exception\TooLongMessageException;
use TextMagicSMS\Exception\TooManyItemsException;
use TextMagicSMS\Exception\UnicodeSymbolsDetectedException;
use TextMagicSMS\Exception\UnknownMessageIdException;
use TextMagicSMS\Exception\WrongParameterValueException;
...
class TextMagicAPI
{
     ...
     * array parameter or through
     * @param array $params Associative array of options
     * @return \TextMagicSMS\TextMagicAPI
     */
     ...
     * @param bool|int $send_time Send time in UNIX timestamp
     *
     * @throws Exception\IPAddressException
     * @throws Exception\UnicodeSymbolsDetectedException
     * @throws \Exception
     * @throws Exception\RequestsLimitExceededException
     * @throws Exception\WrongPhoneFormatException
     * @throws Exception\TooLongMessageException
     * @throws Exception\TooManyItemsException
     * @throws Exception\LowBalanceException
     ...
     *
     * @throws Exception\WrongParameterValueException
     * @throws Exception\IPAddressException
     * @throws \Exception
     * @throws Exception\RequestsLimitExceededException
     * @throws Exception\DisabledAccountException
     * @throws Exception\UnknownMessageIdException
     * @throws Exception\TooManyItemsException
     * @throws Exception\AuthenticationException
     * @return mixed
     */
